...
<div class="row d-flex align-items-center">
    ...
    <div class="col-md-6 col-lg-8 py-4">
        ...
        <p>FinBites memastikan ikan Anda mendapatkan makanan tepat waktu, bahkan ketika kita sibuk. Jadwal yang
            terprogram dan kontrol porsi membuat teman-teman Anda tetap sehat dan bahagia, apa pun yang terjadi."</p>
    </div>
    ...
    <div class="col-md-6 col-lg-4 py-4 bg-white text-dark rounded-4 p-5">
        ...
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <div class="mb-2 fs-5" id="forgot-password">
                <a href="{{ route('recovery') }}" class="text-decoration-none font-small" style="color:#0D4A59">Lupa
                    kata sandi?</a>
            </div>
